...
- OLAP relation surface: `final`, `prewhere`, `sample`, `settings`, `limit_by`, `array_join`, `group_by_period`, `fill`, `rollup`
...
- Rails compatibility harness: ~1,600 vendored upstream Active Record tests run green
